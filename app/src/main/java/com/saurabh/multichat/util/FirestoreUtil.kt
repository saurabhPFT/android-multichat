package com.saurabh.multichat.util
...
import com.saurabh.multichat.model.*
import com.saurabh.multichat.recyclerview.ImageMessageItem
...
object FirestoreUtil {
    ...
    fun initFirestore(){
        firestoreInstance.firestoreSettings= firestoreSettings
    }
    ...
    fun initCurrentUserIfFirstTime(onComplete: () -> Unit) {
        currentUserDocRef.get().addOnSuccessListener{ documentSnapshot ->
            ...
            .addOnFailureListener{
                Log.d("Firestoreutil", "get failed with ", it)
